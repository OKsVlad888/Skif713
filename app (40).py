...
<div style="position:relative;z-index:1;text-align:center;font-size:10px;letter-spacing:2px;color:var(--lc);opacity:.85;margin-bottom:6px;text-transform:uppercase;transition:color .35s">אפליקציה זו מיועדת לחישובים ראשוניים והמחשה בלבד ואינה מהווה ייעוץ הנדסי או תחליף לתכנון מקצועי. כל שימוש בתוצאות הינו באחריותו הבלעדית של המשתמש בלבד.</div>
